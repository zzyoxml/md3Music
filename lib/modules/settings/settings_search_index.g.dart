...
const List<({String label, String category, String aliases})>
  ...
  (label: '车机模式', category: '车机模式', aliases: '车机 车载 常驻 面板 大屏 副屏 副驾 miniplayer 迷你条'),
  (label: '面板宽度', category: '车机模式', aliases: ''),
  (label: '面板位置', category: '车机模式', aliases: '车机 面板 左侧 右侧 停靠 位置'),
