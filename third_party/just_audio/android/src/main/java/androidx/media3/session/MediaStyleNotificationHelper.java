...
public class MediaStyleNotificationHelper {
  ...
  public static class MediaStyle extends androidx.core.app.NotificationCompat.Style {
    ...
    /* package */ RemoteViews generateContentView() {
      ...
      if (actionsToShowInCompact != null) {
        ...
        view.removeAllViews(com.ryanheise.just_audio.R.id.media_actions);
        if (numActionsInCompact > 0) {
          for (int i = 0; i < numActionsInCompact; i++) {
            ...
            view.addView(com.ryanheise.just_audio.R.id.media_actions, button);
          }
        }
      }
      if (showCancelButton) {
        view.setViewVisibility(com.ryanheise.just_audio.R.id.end_padder, View.GONE);
        view.setViewVisibility(com.ryanheise.just_audio.R.id.cancel_action, View.VISIBLE);
        view.setOnClickPendingIntent(
            com.ryanheise.just_audio.R.id.cancel_action, cancelButtonIntent);
        view.setInt(
            com.ryanheise.just_audio.R.id.cancel_action,
            "setAlpha",
            mBuilder
                .mContext
                .getResources()
                .getInteger(com.ryanheise.just_audio.R.integer.cancel_button_image_alpha));
      } else {
        view.setViewVisibility(com.ryanheise.just_audio.R.id.end_padder, View.VISIBLE);
        view.setViewVisibility(com.ryanheise.just_audio.R.id.cancel_action, View.GONE);
      }
      return view;
    }
    ...
    private RemoteViews generateMediaActionButton(
      ...
      RemoteViews button =
          new RemoteViews(
              ...
              com.ryanheise.just_audio.R.layout.media3_notification_media_action);
      IconCompat iconCompat = action.getIconCompat();
      if (iconCompat != null) {
        button.setImageViewResource(com.ryanheise.just_audio.R.id.action0, iconCompat.getResId());
      }
      if (!tombstone) {
        button.setOnClickPendingIntent(
            com.ryanheise.just_audio.R.id.action0, action.getActionIntent());
      }
      button.setContentDescription(com.ryanheise.just_audio.R.id.action0, action.getTitle());
      return button;
    }

    /* package */ int getContentViewLayoutResource() {
      return com.ryanheise.just_audio.R.layout.media3_notification_template_media;
    }
    ...
    /* package */ RemoteViews generateBigContentView() {
      ...
      big.removeAllViews(com.ryanheise.just_audio.R.id.media_actions);
      if (actionCount > 0) {
        for (int i = 0; i < actionCount; i++) {
          final RemoteViews button = generateMediaActionButton(mBuilder.mActions.get(i));
          big.addView(com.ryanheise.just_audio.R.id.media_actions, button);
        }
      }
      if (showCancelButton) {
        big.setViewVisibility(com.ryanheise.just_audio.R.id.cancel_action, View.VISIBLE);
        big.setInt(
            com.ryanheise.just_audio.R.id.cancel_action,
            "setAlpha",
            mBuilder
                ...
                .getResources()
                .getInteger(com.ryanheise.just_audio.R.integer.cancel_button_image_alpha));
        big.setOnClickPendingIntent(com.ryanheise.just_audio.R.id.cancel_action, cancelButtonIntent);
      } else {
        big.setViewVisibility(com.ryanheise.just_audio.R.id.cancel_action, View.GONE);
      }
      return big;
    }
    ...
    /* package */ int getBigContentViewLayoutResource(int actionCount) {
      return actionCount <= 3
          ? com.ryanheise.just_audio.R.layout.media3_notification_template_big_media_narrow
          : com.ryanheise.just_audio.R.layout.media3_notification_template_big_media;
    }
  }
   ...
   * com.ryanheise.just_audio.R.style#TextAppearance_Compat_Notification_Media} or {@link
   * com.ryanheise.just_audio.R.style#TextAppearance_Compat_Notification_Title_Media} in your custom
  ...
  public static class DecoratedMediaCustomViewStyle extends MediaStyle {
    ...
    /* package */ int getContentViewLayoutResource() {
      return mBuilder.getContentView() != null
          ? com.ryanheise.just_audio.R.layout.media3_notification_template_media_custom
    ...
    /* package */ int getBigContentViewLayoutResource(int actionCount) {
      return actionCount <= 3
          ? com.ryanheise.just_audio.R.layout.media3_notification_template_big_media_narrow_custom
          : com.ryanheise.just_audio.R.layout.media3_notification_template_big_media_custom;
    }
    ...
    private void setBackgroundColor(RemoteViews views) {
      ...
      views.setInt(
          com.ryanheise.just_audio.R.id.status_bar_latest_event_content,
          "setBackgroundColor",
          color);
    }
  }
